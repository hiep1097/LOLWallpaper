...
import com.example.hoang.lolwallpaper.Adapters.AdapterViewPager;
import com.example.hoang.lolwallpaper.Entities.ImageFavoriteEntity;
import com.example.hoang.lolwallpaper.Entities.ImageSlideEntity;
import com.example.hoang.lolwallpaper.Event.MessageEvent;
import com.example.hoang.lolwallpaper.Json.JsonUtils;
                    ...
                    public void onResourceReady(Bitmap resource, GlideAnimation glideAnimation) {
                        ...
                        try {
                            ...
                            Uri contentUri = FileProvider
                                    .getUriForFile(getBaseContext(), "com.example.hoang.lolwallpaper.fileprovider", newFile);
                            if (contentUri != null) {
